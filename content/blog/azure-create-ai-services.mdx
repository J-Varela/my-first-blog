---
title: Learn how to create and consume Azure AI Services
description: Module 2 - Learn how to create and consume Azure AI Services
date: 2024-04-03
published: true
---

# Unit 1: Introduction to Azure AI services

**Azure AI Services** are cloud-based services that encapsulate AI capabilities. Rather than a single product, you should think os AI services as a set of individual services that you can use as building block to compose sophisticated, intelligent applications.
...
| Azure AI Trnaslator |                 | Azure AI Custom Vision   | Azure AI Content Moderator |
|                     |                 | Azure AI Face            | Azure AI Personalizer      |

You can use AI services to build your own AI solutions to provide out-of-the-box solutions for common AI scenarios.
...
- **Azure Cognitive Search** - A cloud-scale search solution that use AI services to extract insights from data and documents.
...
- Use the REST API to consume an AI service.
- Use an SDK to consume an AI service.

# Unit 2: Provision an Azure AI services resources
...
You can provision an **AI Services** resource that supports multiple different AI servives. For example, you could create a single resource that enables you tu use the **Azure AI Language, Azure AI Vision, Azure AI Speech**, and other services.
...
Each AI Service can be provisioned individually, for example by creating discrete **AI Language** and **AI Vision** resources in you Azure subscription.

This approach enables you to use separate endpoints of each service (for example to provision them in different geographical regions), and to manage access credentials for each service independently. It also enables you to manage billing separately for each service.
...
![Github Logo](https://learn.microsoft.com/en-us/training/wwl-data-ai/create-manage-ai-services/media/rest-api.png)
...
![Github Logo](https://learn.microsoft.com/en-us/training/wwl-data-ai/create-manage-ai-services/media/sdk.png)
...
1. How are client application typically granted access to an Azure AI Services endpoint?
   - By default, access to an Azure AI Services resource is based on a subscription key.
